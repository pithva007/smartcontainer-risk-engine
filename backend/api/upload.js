...
const { uploadDataset } = require('../src/controllers/uploadController');
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    return sendError(res, 500, 'UPLOAD_FAILED', 'Upload failed.', requestId, err.message);
  }
};
